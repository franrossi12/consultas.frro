    ...
    <tr>
        <td>
            ...
            <div style="font-family:Helvetica,arial,sans-serif;font-size:18px;color:#666666;text-align:center;line-height:24px;letter-spacing:2px;padding:5px 0 20px 0">
                Se solicito el reseteo de tu contraseña, haga click en Resetear Contraseña
            </div>
            <br>

            <div style="margin:0 auto;text-align:center;padding:25px 0 45px 0">
                <a href={{ config('app.url') . '/olvide-contraseña/' . $token }}
            ...
            <div>
                ...
                <b>{{ config('app.url') . '/olvdide-contraseña/' . $token }}</b>
                <br>
                <div>
                    <p>Si usted no solicito resetear la contaseña, desestime este mail</p>
                </div>
            </div>
