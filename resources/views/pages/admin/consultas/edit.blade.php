							...
							<div class="row">
                                <div class="col-md-6 col-lg-6 col-12 col-sm-12 mb-2">
                                    <select class="form-control" name="materia_id" id="materia_id" required>
                                        ...
                                        @foreach($materias as $materia)
                                            <option value="{{$materia->id}}" @if($materia->id === $consulta->materia_id) selected @endif>
                                                {{$materia->descripcion}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 col-lg-6 col-12 col-sm-12 mb-2">
                                    <select class="form-control" name="profesor_id" id="profesor_id" required>
                                        ...
                                        @foreach($profesores as $profesor)
                                            <option value="{{$profesor->id}}" @if($profesor->id === $consulta->profesor_id) selected @endif>
                                ...
                                <div class="col-md-6 col-lg-6 col-12 col-sm-12 mb-2">
                                    <select class="form-control" name="numero_dia" id="numero_dia" required>
                                        ...
                                        @foreach($dias as $dia)
                                            <option value="{{$dia->id}}" @if($dia->id === $consulta->numero_dia) selected @endif>
                                                {{$dia->descripcion }}
                                            </option>
                                        @endforeach
                                    </select>
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="time" name="hora" id="hora"
                                               class="form-control input-sm"  step="2"
                                               value="{{$consulta->hora}}"
                                                required>
									</div>
								</div>
